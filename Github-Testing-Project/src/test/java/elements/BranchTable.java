...
public class BranchTable extends BaseElement {
    ...
    private static final String DELETE_BUTTON_IN_ROW_XPATH = ".//button[.//*[local-name()='svg' and contains(@class, 'octicon-trash')]]";
     ...
     */
    public SelenideElement getRow(String rowText) {
